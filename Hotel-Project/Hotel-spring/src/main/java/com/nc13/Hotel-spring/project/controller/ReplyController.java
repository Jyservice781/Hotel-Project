...
public class ReplyController {
    ...
    public HashMap<String, Object> showList(@PathVariable int hotelId, @RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "10") int size) {
        HashMap<String, Object> result = new HashMap<>();

        result.put("replyList", REPLY_SERVICE.selectList(hotelId, page, size));
